...
DROP SEQUENCE IF EXISTS woj_macarch_id_seq;
CREATE SEQUENCE woj_macarch_id_seq;
DROP TABLE IF EXISTS woj_macarch CASCADE;

CREATE TABLE woj_macarch (
...
DROP SEQUENCE IF EXISTS woj_macchange_id_seq;
CREATE SEQUENCE woj_macchange_id_seq;
DROP TABLE IF EXISTS woj_macchange CASCADE;
CREATE TABLE woj_macchange (
...
DROP SEQUENCE IF EXISTS woj_macok_id_seq;
CREATE SEQUENCE woj_macok_id_seq;
DROP TABLE IF EXISTS woj_macok CASCADE;
CREATE TABLE woj_macok (
...
INSERT INTO dbinfo (keytype, keyvalue) VALUES ('dbversion', '2015061800');
