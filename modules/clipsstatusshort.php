...
$status['clips'] = $_GET['clips'];
$status['username'] = $_GET['username'];


//vlany
$walk=snmpget(10.100.204.251,"public","1.3.6.1.2.1.17.7.1.4.5.1.1");
$counter=explode(":",$walk);
$portstatus['uvlan'] = $counter[1];

$walk=snmpwalkoid(10.100.204.251,"public","1.3.6.1.2.1.31.1.2.1.3");
...
$SMARTY->display('clipsstatusshort.html');
